        ...
        function hovered() {
            document.getElementById("hcks").style.background = "#00736b";
        }

        function unhovered() {
            document.getElementById("hcks").style.background = "#00635E";
        }

        function hidecks() {
            document.getElementById("cookie").style.display = "none";
            setCookie("ck_d1b56bdc496eb931", "y", 30);
        }
        ...
        function skr_ckz() {
            let x = getCookie("ck_d1b56bdc496eb931");
            if (!x) {
                ...
                c.style.background = "#1a2625";
                c.style.color = "#e3e3e3";
                hc.style.background = "#00635E";
                hc.style.color = "#e3e3e3";
                c.innerHTML = "<span id=\"cinfo\" style=\"flex: 1 1 auto; margin-top: 2px;\">We use cookies to enhance your experience on our site. Press Accept to give your consent. [&nbsp;<a href=\"https://www.privacypolicygenerator.info/live.php?token=BvixHMPQHTQUWUwTcrz8JVbKAVi4nsBx\" target=\"_blank\" style=\"text-decoration:underline;color:#e3e3e3;\">more information</a>&nbsp;]</span>";
                hc.innerHTML = "Accept";
                c.style.left = "0px";
                c.style.right = "0px";
                c.style.bottom = "0px";
